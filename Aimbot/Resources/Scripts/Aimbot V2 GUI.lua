...
loadstring(game:HttpGet("https://raw.githubusercontent.com/STANTHECHEESEMAN/Cheeseman_GT-s-Script-Hub/main/Aimbot/Resources/Scripts/Raw%20Main.lua"))()
...
local MainFrame = Library:CreateWindow({
	...
	Themeable = {
		Image = "7059346386",
		Info = "Made by Exunys\nPowered by Pepsi's UI Library/nReuploaded by Cheeseman_GT",
		Credit = false
	},
	Background = "",
